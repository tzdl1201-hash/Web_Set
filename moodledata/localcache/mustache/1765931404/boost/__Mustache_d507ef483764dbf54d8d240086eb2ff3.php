...
class __Mustache_d507ef483764dbf54d8d240086eb2ff3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="ms-auto dropdown">
';
        $value = $context->find('settingsselector');
        $buffer .= $this->section10022c28d91c0d5f849080287b9b17f1($context, $indent, $value);
        $value = $context->find('settingsselector');
        if (empty($value)) {
            ...
            $buffer .= $this->section10944fd45506037b8f9e7dcd15bfccc8($context, $indent, $value);
            $buffer .= '"
';
...
';
            $buffer .= $indent . '           data-bs-boundary="window"
';
...
';
        ...
        $buffer .= $indent . '    <div class="dropdown-menu dropdown-menu-end"
';
...
';
    ...
    private function section10022c28d91c0d5f849080287b9b17f1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section10944fd45506037b8f9e7dcd15bfccc8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'btn-icon colour-inherit text-decoration-none d-flex';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
            foreach ($values as $value) {
                ...
                $buffer .= 'btn-icon colour-inherit text-decoration-none d-flex';
                $context->pop();
            }
        }
