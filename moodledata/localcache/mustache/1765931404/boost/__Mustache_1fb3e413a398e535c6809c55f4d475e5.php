...
class __Mustache_1fb3e413a398e535c6809c55f4d475e5 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    ';
        $value = $context->find('sectionid');
        $buffer .= $this->sectionA2a2c1d787797721d03d4d7ac99ce273($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '    ';
...
';
    ...
    private function sectionA2a2c1d787797721d03d4d7ac99ce273(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'data-section-id="{{.}}"';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
