...
class __Mustache_d45da3f0b97981b0d76d78e01b18c598 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section299772a11c524408a61f5e35de46af7e($context, $indent, $value);
        $buffer .= $indent . '
';
        $value = $context->find('hasconditions');
        if (empty($value)) {
...
';
    ...
    private function section90a7db8b8c5f60f8570a4e36f4c6583e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionEfbbb4530ceb18dd9de2bff9c5ea8d35(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section4a03e71394db8eff030e7b285cad0806(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section186e32eaaa36e871af4b6d6f6b3d06e9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section90a7db8b8c5f60f8570a4e36f4c6583e($context, $indent, $value);
                $value = $context->find('statuscompletefail');
                $buffer .= $this->sectionEfbbb4530ceb18dd9de2bff9c5ea8d35($context, $indent, $value);
                $value = $context->find('statusincomplete');
                $buffer .= $this->section4a03e71394db8eff030e7b285cad0806($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function sectionA6ecdee1e45022540cc246f1c9566a9c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $value = $context->find('istrackeduser');
                $buffer .= $this->section186e32eaaa36e871af4b6d6f6b3d06e9($context, $indent, $value);
                $buffer .= $indent . '
';
                $value = $context->find('istrackeduser');
                if (empty($value)) {
...
';
    ...
    private function section299772a11c524408a61f5e35de46af7e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionA6ecdee1e45022540cc246f1c9566a9c($context, $indent, $value);
                $buffer .= $indent . '
';
