...
class __Mustache_3564fd28f43c839602a334a200ea5f77 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0104aeae060d8ea14c2543818c7719fb($context, $indent, $value);
...
';
    ...
    private function section0104aeae060d8ea14c2543818c7719fb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawerheadercontent' => array($this, 'blockD15befe1ae603b84014fbf6baad67e72'),
...
';
    ...
    public function blockD15befe1ae603b84014fbf6baad67e72($context)
    {
        $indent = $buffer = '';
