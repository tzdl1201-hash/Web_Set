...
class __Mustache_e5cd1093277153a3f0f2cbd6553201cb extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE492f1d6e1c74cc6a538e544f2ffd85e($context, $indent, $value);
        $value = $context->find('hasblocks');
        $buffer .= $this->section40ad56e774018306232a28f4d66efb33($context, $indent, $value);
...
';
        $value = $context->find('courseindex');
        $buffer .= $this->section973117d406d60cabd060591c53f0aa4a($context, $indent, $value);
        $value = $context->find('hasblocks');
        $buffer .= $this->section6662fabff9a36bd4aa5d79d1a084ac63($context, $indent, $value);
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                ';
...
';
        ...
        $buffer .= $this->sectionB0586239cf2389a48a06dea9f6c14bfa($context, $indent, $value);
        $buffer .= $indent . '                            ';
...
';
    ...
    private function sectionE492f1d6e1c74cc6a538e544f2ffd85e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawercontent' => array($this, 'block8504bccc3d5ba35656d9cf4f19e4c75c'),
    ...
    private function section40ad56e774018306232a28f4d66efb33(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawercontent' => array($this, 'block2b1c1e92d45c6fe617dbed071716e0ad'),
    ...
    private function section973117d406d60cabd060591c53f0aa4a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section6662fabff9a36bd4aa5d79d1a084ac63(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                        <div class="drawer-toggler drawer-right-toggle d-print-none">
';
                $buffer .= $indent . '                            <button
';
                $buffer .= $indent . '                                class="btn icon-no-margin"
...
';
    ...
    private function sectionB0586239cf2389a48a06dea9f6c14bfa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function block8504bccc3d5ba35656d9cf4f19e4c75c($context)
    {
        $indent = $buffer = '';
        $buffer .= '                    ';
...
';
    ...
    public function block2b1c1e92d45c6fe617dbed071716e0ad($context)
    {
        $indent = $buffer = '';
