...
/**
 * Strings for component 'certificate', language 'zh_tw', version '5.0'.
 *
 * @package     certificate
 * @category    string
...
$string['modulename_help'] = '此單元根據老師設定的條件靈活地發出證書。';
