...
/**
 * Strings for component 'portfolio_picasa', language 'zh_tw', version '5.0'.
 *
...
$string['nooauthcredentials'] = '需要OAuth憑證';
$string['nooauthcredentials_help'] = '要使用Picasa歷程檔案外掛，您需要在這歷程檔案設定中配置OAuth憑證。';
...
$string['secret'] = '密碼';
$string['sendfailed'] = '這檔案{$a}無法轉移到Picasa';
