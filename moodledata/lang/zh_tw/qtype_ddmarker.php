...
/**
 * Strings for component 'qtype_ddmarker', language 'zh_tw', version '5.0'.
 *
...
$string['pluginname'] = '拖放標記題';
$string['pluginname_help'] = '拖放標記題要求作答者依照試題敘述把一些文字標籤拖放到指定的背景圖上的放置區。';
$string['pluginname_link'] = 'question/type/ddmarker';
$string['pluginnameadding'] = '新增拖放標記題';
$string['pluginnameediting'] = '編輯拖放標記題';
