...
/**
 * Strings for component 'filters', language 'zh_tw', version '5.0'.
 *
 * @package     filters
 * @category    string
...
$string['filtersettingsforin'] = '在{$a->context}中過濾器{$a->filter}的設定';
...
$string['limiterfor'] = '{$a}欄位分隔符號';
$string['neveraccessed'] = '從未被存取過';
$string['nevermodified'] = '從未被修改過';
$string['newfilter'] = '新過濾器';
$string['nofiltersenabled'] = '在這網站沒有過濾器被啟用。';
$string['off'] = '關閉';
$string['offbutavailable'] = '關閉，但是可用';
$string['on'] = '開啟';
$string['privacy:reason'] = '過濾子系統不會儲存任何個人資料。';
$string['profilefilterfield'] = '個人資料表欄位名稱';
$string['profilefilterlimiter'] = '個人資料表欄位分隔符號';
