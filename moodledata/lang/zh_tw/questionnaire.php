...
/**
 * Strings for component 'questionnaire', language 'zh_tw', version '5.0'.
 *
...
$string['maxdigitsallowed_help'] = '透過使用最多允許的數字及Nb的小數點參數，您可以指明小數點的長度及需要的小數位。';
...
$string['removenotinuse'] = '此問卷是';
$string['required'] = '一定要回應';
