...
/**
 * Strings for component 'choice', language 'zh_tw', version '5.0'.
 *
 * @package     choice
 * @category    string
...
$string['eventanswercreated'] = '已回應投票';
$string['eventanswerdeleted'] = '投票結果已刪除';
$string['eventanswersubmitted'] = '已完成投票';
...
$string['limitanswers_help'] = '<p>這個選項允許您限制選擇某一選項的參與者數目。這功能適合用來做有人數上限的志願分組</p>
　　
...
$string['moveselectedusersto'] = '把被選出的用戶搬移到.....';
...
$string['previewing'] = '這只是本活動可用選項的預覽，開放後您將能進行選擇。';
$string['previewonly'] = '這只是這一活動的可用選項的預覽。你要等到{$a}才可以進行投票。';
$string['privacy'] = '結果檢視設定';
$string['privacy:metadata:choice_answers:optionid'] = '這用戶所選出的選項的ID';
$string['publish'] = '公佈結果';
...
$string['publishinfoanonafter'] = '匿名結果將在您投票後公佈。';
$string['publishinfoanonclose'] = '匿名結果將在活動結束後公佈。';
$string['publishinfofullafter'] = '完整的結果，顯示每個人的選擇，將在您投票後公佈。';
$string['publishinfofullclose'] = '完整的結果，顯示每個人的選擇，將在活動結束後公佈。';
$string['publishinfonever'] = '此活動的結果將不會在您投票後公佈。';
