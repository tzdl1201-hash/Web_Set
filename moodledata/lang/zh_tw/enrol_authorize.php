...
/**
 * Strings for component 'enrol_authorize', language 'zh_tw', version '5.0'.
 *
...
將<a href="{$a->url}">使用HTTPS登入</a>”勾選為\'是\'，以使用這一外掛。';
$string['adminconfighttpsgo'] = '到 <a href="{$a->url}">安全頁面</a> 設定這一外掛。';
...
$string['adminhelpcapturetitle'] = '已排程的擷取日期';
$string['adminhelpreviewtitle'] = '訂單審查';
...
$string['capture'] = '擷取';
$string['capturedpendingsettle'] = '已擷取 / 等待付款';
$string['capturedsettled'] = '已擷取 / 已付款';
$string['captureyes'] = '將取得信用卡資訊，並且將學生加選到課程，您確定？';
$string['cccity'] = '城市';
$string['ccexpire'] = '到期日';
$string['ccexpired'] = '信用卡已過期';
$string['ccinvalid'] = '無效的卡號';
...
$string['echeckbusinesschecking'] = '商業支票';
$string['echeckchecking'] = '支票';
...
現在有{$a->count} 張等待中的數位支票(echecks)，您需要上傳一個 csv 檔案來加選用戶。

點選連結並閱讀頁面上的說明檔案： {$a->url}';
...
$string['welcometocoursesemail'] = '親愛的同學， 感謝你的付款。您已經注冊了這些課程： {$a->courses}
您可以編輯個人資料： {$a->profileurl}
您可以查看您的付款細目: {$a->paymenturl}';
