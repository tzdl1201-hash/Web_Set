...
/**
 * Strings for component 'auth_radius', language 'zh_tw', version '5.0'.
 *
 * @package     auth_radius
 * @category    string
...
$string['auth_radiusdescription'] = '這一方法使用一台<a href="http://en.wikipedia.org/wiki/RADIUS" target="_blank">RADIUS</a> 伺服器以檢查指定的用戶帳號和密碼是否有效。';
