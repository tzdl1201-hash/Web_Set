...
/**
 * Strings for component 'editor_tinymce', language 'zh_tw', version '5.0'.
 *
...
$string['advanced:charmap_desc'] = '插入特殊字元';
...
$string['advanced:colorpicker_delta_height'] = '拾色器高';
$string['advanced:colorpicker_delta_width'] = '拾色器寬';
...
$string['advanced:image_delta_height'] = '圖像高度';
$string['advanced:image_delta_width'] = '圖像寬度';
...
$string['advanced:link_delta_height'] = '鏈結高度';
$string['advanced:link_delta_width'] = '鏈結寬度';
...
$string['advanced:undo_desc'] = '復原(Ctrl+Z)';
...
$string['advanced_dlg:charmap_title'] = '選擇特殊字元';
...
$string['advanced_dlg:colorpicker_picker_tab'] = '選顏色';
$string['advanced_dlg:colorpicker_picker_title'] = '挑選顏色';
...
$string['advanced_dlg:image_align_bottom'] = '底部對齊';
...
$string['advanced_dlg:image_dimensions'] = '圖像尺寸';
...
$string['advanced_dlg:link_target_blank'] = '在新視窗開啟鏈接';
$string['advanced_dlg:link_target_same'] = '在同一視窗開啟鏈接';
...
$string['advimage:delta_height'] = '高';
$string['advimage:delta_width'] = '寬';
$string['advimage:image_desc'] = '插入/編輯圖像';
$string['advimage_dlg:align'] = '對齊方式';
$string['advimage_dlg:align_baseline'] = '基線';
$string['advimage_dlg:align_bottom'] = '底部對齊';
$string['advimage_dlg:align_left'] = '靠左對齊';
$string['advimage_dlg:align_middle'] = '居中對齊';
$string['advimage_dlg:align_right'] = '靠右對齊';
$string['advimage_dlg:align_textbottom'] = '文字下方';
$string['advimage_dlg:align_texttop'] = '文字上方';
$string['advimage_dlg:align_top'] = '上方對齊';
...
$string['advimage_dlg:dimensions'] = '向度';
...
$string['advimage_dlg:long_desc'] = '連結描述';
$string['advimage_dlg:ltr'] = '由左到右';
$string['advimage_dlg:map'] = '圖像熱點';
$string['advimage_dlg:misc'] = '其他';
$string['advimage_dlg:missing_alt'] = '是否確定不為圖像加入說明文字？若沒有加入說明文字，當使用者使用不載入圖像或字型的瀏覽器時，將會看不到這個圖像。';
...
$string['advimage_dlg:swap_image'] = '切換圖片';
...
$string['advlink_dlg:advanced_props'] = '進階屬性';
...
$string['autosave:unload_msg'] = '如果離開此頁面將導致所做的更改全部遺失。';
...
$string['common:apply'] = '應用';
$string['common:browse'] = '瀏覽';
$string['common:cancel'] = '取消';
$string['common:class_name'] = '樣式';
$string['common:clipboard_msg'] = '在Mozilla和Firefox中無法使用複製/剪下/貼上的功能。你是否需要瞭解有關此問題的更多訊息？';
$string['common:clipboard_no_support'] = '未支援您的瀏覽器，請使用鍵盤快速鍵';
$string['common:close'] = '關閉';
$string['common:edit_confirm'] = '是否切換到「所見即所得」模式？';
...
$string['common:not_set'] = '--未設置--';
$string['common:popup_blocked'] = '抱歉！快顯視窗已被阻止，請調整瀏覽器設置，允許此網站可彈出新視窗，以便使用此工具';
$string['common:update'] = '更新';
$string['common:value'] = '(值)';
$string['contextmenu:align'] = '對齊方式';
$string['contextmenu:center'] = '居中對齊';
$string['contextmenu:full'] = '兩端對齊';
$string['contextmenu:left'] = '靠左對齊';
$string['contextmenu:right'] = '靠右對齊';
$string['customconfig'] = '自定環境';
$string['customconfig_desc'] = '在 JSON 格式的自行定義的進階 TimyMCE 配置，例如：{"option1" : "value2", "option2" : "value2"}。在此指定的任何選項會覆蓋標準和外掛的設定。';
...
$string['fontselectlist'] = '可使用的字型清單';
$string['fullpage:delta_height'] = '';
$string['fullpage:delta_width'] = '';
$string['fullpage:desc'] = '文檔案屬性';
$string['fullpage_dlg:active_color'] = 'Active顏色';
$string['fullpage_dlg:add'] = '新增元素';
$string['fullpage_dlg:add_base'] = '基本元素';
$string['fullpage_dlg:add_comment'] = '';
$string['fullpage_dlg:add_link'] = 'Link元素';
$string['fullpage_dlg:add_meta'] = '後設元素';
$string['fullpage_dlg:add_script'] = '腳本元素';
$string['fullpage_dlg:add_style'] = '風格元素';
$string['fullpage_dlg:add_title'] = '標題元素';
...
$string['fullpage_dlg:appearance_marginprops'] = '';
$string['fullpage_dlg:appearance_style'] = '樣式表及樣式屬性';
$string['fullpage_dlg:appearance_tab'] = '外觀';
$string['fullpage_dlg:appearance_textprops'] = '文字屬性';
$string['fullpage_dlg:author'] = '作者';
$string['fullpage_dlg:base_element'] = 'Base元素';
$string['fullpage_dlg:bgcolor'] = '背景顏色';
$string['fullpage_dlg:bgimage'] = '背景圖像';
$string['fullpage_dlg:bottom_margin'] = '下邊界';
$string['fullpage_dlg:charset'] = '字元集';
$string['fullpage_dlg:comment_element'] = '';
$string['fullpage_dlg:content'] = '內容';
$string['fullpage_dlg:copyright'] = '版權';
$string['fullpage_dlg:defer'] = '延遲';
$string['fullpage_dlg:doctypes'] = '';
$string['fullpage_dlg:encoding'] = '字元編碼';
$string['fullpage_dlg:font_face'] = '字體';
$string['fullpage_dlg:font_size'] = '字體尺寸';
$string['fullpage_dlg:fontface'] = '字型體系';
$string['fullpage_dlg:fontsize'] = '字體大小';
$string['fullpage_dlg:general_props'] = '一般';
$string['fullpage_dlg:head_elements'] = 'Head元素';
$string['fullpage_dlg:hover_color'] = 'Hover顏色';
$string['fullpage_dlg:href'] = 'HREF';
$string['fullpage_dlg:hreflang'] = 'HREF lang';
$string['fullpage_dlg:info'] = '資訊';
$string['fullpage_dlg:langcode'] = '語言編碼';
$string['fullpage_dlg:langdir'] = '語言書寫方向';
...
$string['fullpage_dlg:link_element'] = '';
$string['fullpage_dlg:ltr'] = '由左到右';
$string['fullpage_dlg:media'] = '媒體';
$string['fullpage_dlg:meta_description'] = '內容說明';
$string['fullpage_dlg:meta_element'] = '';
$string['fullpage_dlg:meta_index_follow'] = '';
$string['fullpage_dlg:meta_index_nofollow'] = '';
$string['fullpage_dlg:meta_keywords'] = '關鍵字';
$string['fullpage_dlg:meta_noindex_follow'] = '';
$string['fullpage_dlg:meta_noindex_nofollow'] = '';
...
$string['fullpage_dlg:movedown'] = '將選出的元素往下移';
$string['fullpage_dlg:moveup'] = '將選出的元素往上移';
$string['fullpage_dlg:name'] = '名稱';
$string['fullpage_dlg:properties'] = '屬性';
$string['fullpage_dlg:rel'] = '';
$string['fullpage_dlg:remove'] = '移除選出的元素';
$string['fullpage_dlg:rev'] = '';
$string['fullpage_dlg:right_margin'] = '右邊界';
$string['fullpage_dlg:rtl'] = '由右到左';
$string['fullpage_dlg:script_element'] = 'script元素';
...
$string['fullpage_dlg:title'] = '檔案屬性';
...
$string['fullpage_dlg:visited_color'] = '';
...
$string['insertdatetime:months_short'] = '一,二,三,四,五,六,七,八,九,十,十一,十二';
$string['insertdatetime:time_fmt'] = '%H:%M:%S';
$string['layer:absolute_desc'] = '開關絕對位置';
$string['layer:backward_desc'] = '置後';
$string['layer:content'] = '新建圖層...';
$string['layer:forward_desc'] = '移到上層';
$string['layer:insertlayer_desc'] = '插入圖層';
$string['media:delta_height'] = '';
$string['media:delta_width'] = '';
$string['media:desc'] = '插入/編輯嵌入的媒體';
$string['media:edit'] = '編輯嵌入式媒體';
$string['media_dlg:advanced'] = '進階';
$string['media_dlg:align'] = '對齊';
$string['media_dlg:align_bottom'] = '靠下方';
$string['media_dlg:align_bottom_left'] = '靠左下';
$string['media_dlg:align_bottom_right'] = '靠右下';
$string['media_dlg:align_center'] = '中間';
$string['media_dlg:align_left'] = '靠左';
$string['media_dlg:align_right'] = '靠右';
$string['media_dlg:align_top'] = '靠上方';
$string['media_dlg:align_top_left'] = '靠左上';
$string['media_dlg:align_top_right'] = '靠右上';
...
$string['media_dlg:maintainaspect'] = '保持比例';
...
$string['media_dlg:qtsrc'] = 'QT 來源';
$string['media_dlg:qtsrcchokespeed'] = '';
...
$string['media_dlg:rmp_options'] = 'Real Media播放器的選項';
$string['media_dlg:salign'] = 'SAlign';
$string['media_dlg:scale'] = '縮放';
...
$string['media_dlg:title'] = '插入/編輯嵌入的媒體';
...
$string['nonbreaking:nonbreaking_desc'] = '插入非跳頁的空白字元';
...
$string['save:cancel_desc'] = '取消所有變更';
$string['save:save_desc'] = '保存';
$string['searchreplace:delta_height'] = '';
$string['searchreplace:delta_width'] = '';
$string['searchreplace:replace_desc'] = '尋找/取代';
$string['searchreplace:search_desc'] = '尋找';
...
$string['searchreplace_dlg:search_title'] = '尋找';
$string['searchreplace_dlg:searchnext_desc'] = '再次尋找';
...
$string['style_dlg:block_letterspacing'] = '字元間距';
...
$string['style_dlg:text_variant'] = '變形';
...
$string['table_dlg:colgroup'] = '縱行分組';
...
$string['template_dlg:months_short'] = '一,二,三,四,五,六,七,八,九,十,十一,十二';
...
$string['xhtmlxtras_dlg:attribute_label_accesskey'] = '快速鍵';
...
$string['xhtmlxtras_dlg:attribute_label_id'] = '編號';
...
$string['xhtmlxtras_dlg:attribute_label_tabindex'] = '選項卡索引';
