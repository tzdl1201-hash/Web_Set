...
/**
 * Strings for component 'auth_pop3', language 'zh_tw', version '5.0'.
 *
 * @package     auth_pop3
 * @category    string
...
$string['auth_pop3description'] = '該方法使用一個POP3伺服器來檢驗用戶名和密碼。';
