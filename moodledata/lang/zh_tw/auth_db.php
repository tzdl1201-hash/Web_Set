...
/**
 * Strings for component 'auth_db', language 'zh_tw', version '5.0'.
 *
 * @package     auth_db
 * @category    string
...
$string['auth_dbinsertuserduplicate'] = '插入用戶 {$a->username} 時發生錯誤 -- 有這一名稱的用戶已經由 \'{$a->auth}\' 外掛套件所建立。';
...
$string['auth_dbsaltedcrypt'] = '以單向字串雜湊法加密';
...
$string['auth_dbsyncuserstask'] = '將用戶同步的任務';
...
$string['auth_dbupdateusers'] = '更新用戶';
$string['auth_dbupdateusers_description'] = '除了插入新用戶之外，也更新用戶';
