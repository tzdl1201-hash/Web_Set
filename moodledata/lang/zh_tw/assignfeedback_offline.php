...
/**
 * Strings for component 'assignfeedback_offline', language 'zh_tw', version '5.0'.
 *
...
$string['ignoremodified'] = '如果評分試算表比較新，允許更改已評分登記的紀錄。';
...
$string['privacy:nullproviderreason'] = '這一外掛程式沒有使用資料庫儲存用戶資訊。它只使用在作業模組的API來協助顯示評分的介面。';
$string['processgrades'] = '匯入成績';
$string['skiprecord'] = '跳過紀錄';
$string['updatedgrades'] = '更新了 {$a} 筆成績和回饋資料';
