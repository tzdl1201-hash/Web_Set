...
/**
 * Strings for component 'tool_lp', language 'zh_tw', version '5.0'.
 *
 * @package     tool_lp
 * @category    string
...
$string['aplanswerecreated'] = '已建立{$a}學習計畫';
...
$string['competencyframeworksrepository'] = '核心能力架構倉儲';
...
$string['movecompetencyafter'] = '移動核心能力到\'{$a}\'之後';
...
$string['unlinkplantemplateconfirm'] = '取消學習計畫 \'{$a}\'與其樣版的連結？如此一來，對於樣版所做的任何變更將不會再套用到這一學習計畫。此一動作是無法取消的。';
