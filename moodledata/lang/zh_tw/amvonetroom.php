...
/**
 * Strings for component 'amvonetroom', language 'zh_tw', version '5.0'.
 *
 * @package     amvonetroom
 * @category    string
...
$string['amvonetroom:moderator'] = '主席';
$string['error'] = '{$a}';
...
$string['moderator'] = '調節。';
$string['modulenameplural'] = 'AMVONET研討會';
$string['name_live_this_session'] = '研討會的名稱';
$string['pluginadministration'] = 'AMVONET研討會管理';
$string['pluginname'] = 'AMVONET研討會';
$string['status_active_till'] = '直到';
$string['status_blocked'] = '已被封鎖';
$string['status_blocked_since'] = '自從';
