...
/**
 * Strings for component 'lti', language 'zh_tw', version '5.0'.
 *
 * @package     lti
 * @category    string
...
$string['basiclti_in_new_window_open'] = '若新視窗沒優開啟，就點選這裡。';
...
$string['courseexternaltooleditsuccess'] = '變更已儲存';
...
$string['enterkeyandsecret_help'] = '若你有拿到一個客戶密鑰和/或共用的密碼，把它們輸入這裡';
$string['errorbadurl'] = '網址不是一個有效的工具網址或載具';
$string['errorincorrectconsumerkey'] = '客戶密鑰不正確';
$string['errorinvaliddata'] = '無效的資料：{$a}';
$string['errorinvalidmediatype'] = '無效的媒體類型：{$a}';
$string['errorinvalidresponseformat'] = '無效的內容-項目反應格式';
$string['errormisconfig'] = '配置錯誤的工具。請要求你的Moodle管理員修護這工具的設定。';
$string['errortooltypenotfound'] = '沒有找到外部工具類型';
$string['existing_window'] = '現存的視窗';
$string['extensions'] = '學習工具互通性擴展服務';
$string['external_tool_type'] = '預先配置的工具';
...
$string['password'] = '共享的密鑰';
$string['password_admin'] = '共享的密鑰';
...
$string['secure_launch_url'] = '安全起動網址';
...
$string['show_in_course_activity_chooser'] = '以預先配置的工具的形式顯示在活動挑選器上';
$string['show_in_course_lti1'] = '工具配置用法';
$string['show_in_course_lti2'] = '工具配置用法';
$string['show_in_course_no'] = '不要顯示；只用在有輸入配對的工具的網址時才使用';
$string['show_in_course_preconfigured'] = '當添加一外部工具時，顯示為預先配置的工具';
$string['size'] = '大小參數';
...
$string['successfullyfetchedtoolconfigurationfromcontent'] = '已經從所選出內容中成功提取工具配置';
