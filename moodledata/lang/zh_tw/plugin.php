...
/**
 * Strings for component 'plugin', language 'zh_tw', version '5.0'.
 *
 * @package     plugin
 * @category    string
...
$string['supportedconversions'] = '有支援的文件格式轉換';
...
$string['type_customfield_plural'] = '自訂欄位';
...
$string['type_fileconverter'] = '文件格式轉換器';
$string['type_fileconverter_plural'] = '文件格式轉換器';
$string['type_fileconvertermanage'] = '管理文件轉換器';
...
$string['type_media'] = '媒體播放器';
$string['type_media_plural'] = '媒體播放器';
$string['type_message'] = '訊息傳送';
$string['type_message_plural'] = '訊息傳送';
