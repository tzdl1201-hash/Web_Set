...
/**
 * Strings for component 'advmindmap', language 'zh_tw', version '5.0'.
 *
 * @package     advmindmap
 * @category    string
...
$string['errorinvalidadvmindmap'] = '心智圖事例不正確';
...
$string['instances'] = '心智圖實例';
$string['invalidid'] = '心智圖 ID 不正確';
$string['largeconvas'] = '放大編輯區';
$string['lastupdated'] = '最新更新：';
$string['lockedbyyou'] = '此群組心智圖已為你鎖定。您可按此';
$string['modulename'] = '心智圖';
$string['modulenameplural'] = '心智圖';
$string['notavailable'] = '仍無法使用';
$string['numdummygroups'] = '虛擬群組之數量';
$string['pluginadministration'] = '心智圖管理';
$string['pluginname'] = '心智圖';
$string['print'] = '列印';
