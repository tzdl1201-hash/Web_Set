...
/**
 * Strings for component 'data', language 'zh_tw', version '5.0'.
 *
 * @package     data
 * @category    string
...
$string['autogenallforms'] = '產生所有預設樣版';
...
$string['calendarend'] = '{$a} 關閉';
$string['calendarstart'] = '{$a} 開啟';
$string['cancel'] = '取消';
...
$string['closebeforeopen'] = '你所指定的結束日期早於開始日期';
$string['columns'] = '欄位';
$string['comment'] = '評論';
...
$string['completionentriescount'] = '資料筆數';
$string['completionentriesdesc'] = '需要的最少條目數：{$a}';
...
$string['csvwithselecteddelimiter'] = '<acronym title="Comma Separated Values">CSV</acronym> 文字及選用的分隔符號為：';
...
$string['data:managetemplates'] = '管理樣版';
...
$string['errorpresetexists'] = '已經有一個範本使用您所選出的名稱';
...
$string['eventtemplateupdated'] = '樣版已經更新';
$string['eventtemplateviewed'] = '已檢視樣版';
...
$string['fieldwidthlistview'] = '列表檢視的寬度';
...
$string['foundrecords'] = '在 {$a->max} 筆記錄中找到 {$a->num} 筆。<a href="{$a->reseturl}">清除全部</a>';
...
$string['includetags'] = '包含標籤';
$string['includetime'] = '包含加入或修改時間';
$string['includeuserdetails'] = '包含用戶資料';
$string['indicator:cognitivedepth'] = '資料庫的認知深度';
$string['indicator:cognitivedepth_help'] = '這指標是代表這學生在資料庫活動所達到的認知深度';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = '資料庫的社會廣度';
$string['indicator:socialbreadth_help'] = '這指標是代表這學生在資料庫活動所達到的社會廣度';
...
$string['latlongboth'] = '需要同時提供緯度與經度。';
...
$string['mappingwarning'] = '所有沒對應新欄位的舊欄位將會遺失，在這欄位裡的所有資料也會被移除。';
...
$string['multipletags'] = '找到多個標籤！樣版未儲存';
$string['newentry'] = '新資料';
...
$string['norecords'] = '尚無任何資料';
$string['notapproved'] = '等待審核';
...
$string['openafterclose'] = '你指定的開放日期晚於關閉日期';
...
$string['presets'] = '範本';
$string['privacy:metadata:commentpurpose'] = '對資料庫紀錄的評論';
$string['privacy:metadata:data_content:content'] = '內容';
$string['privacy:metadata:data_content:content1'] = '額外內容1';
$string['privacy:metadata:data_content:content2'] = '額外內容2';
$string['privacy:metadata:data_content:content3'] = '額外內容3';
$string['privacy:metadata:data_content:content4'] = '額外內容4';
$string['privacy:metadata:data_content:fieldid'] = '欄位定義的編號';
$string['privacy:metadata:data_records'] = '呈現資料庫活動模組的紀錄';
$string['privacy:metadata:data_records:approved'] = '認可狀態';
$string['privacy:metadata:data_records:groupid'] = '群組';
$string['privacy:metadata:data_records:timecreated'] = '記錄被建立的時間';
$string['privacy:metadata:data_records:timemodified'] = '紀錄最後一次修改的時間';
$string['privacy:metadata:data_records:userid'] = '哪一位用戶建立這一筆紀錄';
$string['privacy:metadata:datafieldnpluginsummary'] = '資料庫活動模組的編號';
$string['privacy:metadata:filepurpose'] = '資料庫紀錄的附加檔案';
$string['privacy:metadata:ratingpurpose'] = '資料庫紀錄的評等';
$string['privacy:metadata:tagpurpose'] = '資料庫紀錄的標籤';
...
$string['removealldatatags'] = '移除所有的資料庫標籤';
...
$string['requiredentrieswarning'] = '這一設定已經被另外一個活動完成設定"需要有條目"所取代';
$string['requiredfield'] = '必要的欄位';
$string['resetsettings'] = '重設過濾器';
$string['resettemplate'] = '重設樣版';
$string['resizingimages'] = '調整縮圖大小...';
$string['rows'] = '列';
$string['rssglobaldisabled'] = '停用，檢視網站設定變數。';
$string['rsstemplate'] = 'RSS';
$string['rsstitletemplate'] = 'RSS標題樣版';
...
$string['tagarea_data_records'] = '資料紀錄';
$string['tags'] = '標籤';
$string['tagsdeleted'] = '資料庫標籤已經被刪除';
$string['teachersandstudents'] = '{$a->teachers} 與 {$a->students}';
$string['templates'] = '樣版';
$string['templatesaved'] = '樣版儲存了';
$string['text'] = '文字';
