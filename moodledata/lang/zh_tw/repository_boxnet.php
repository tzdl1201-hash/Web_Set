...
/**
 * Strings for component 'repository_boxnet', language 'zh_tw', version '5.0'.
 *
...
$string['information'] = '從這<a href="https://app.box.com/developers/services">Box.net 發展者頁面</a> 為你的Moodle網站取得一客戶編號和密碼。';
$string['invalidpassword'] = '無效的密碼';
$string['nullfilelist'] = '沒有檔案在這一倉儲';
$string['password'] = '密碼';
$string['pluginname'] = 'Box.net';
$string['pluginname_help'] = '在Box.net的倉儲';
$string['saved'] = 'Box.net 資料已儲存';
