...
/**
 * Strings for component 'checklist', language 'zh_tw', version '5.0'.
 *
 * @package     checklist
 * @category    string
...
$string['autoupdate2'] = '當完成課程或單元後，在清單上的項目打勾。';
$string['autoupdate2_help'] = '當您完成課程中的相關活動後，清單上的項目便會自動勾除<br />
如果對活動開啟了完成追踪的設定，這會用於在清單上的項目打勾紀錄。<br>
每個活動的完成方式都不一樣 - 例如\'檢視\' 資源、 \'遞交\' 一個測驗或作業、 \'發表\' 一篇文章到討論區或參與聊天等（如果想了解活動標記為 \'完成\' 的原因, 請詢問您的網站管理員查看檔案 \'mod/checklist/autoupdate.php\'<br>
如果一個項目被連接到課程，而對該課程亦啟用了完成追踪的設定，在該課程標記為完成後，該項目便會更新。';
...
$string['items'] = '檢核表項目';
$string['linkcourses'] = '允許項目連接到課程';
$string['linkcourses_desc'] = '當啟用這功能後，清單上的項目便可在moodle連接到課程，並在相關課程完成後標記為完成。啟用這功能後，在含大量課程的網頁編輯清單項目時或會影響到系統運作。';
$string['linkto'] = '連接到';
$string['linktocourse'] = '和此項目相關的課程';
$string['linktomodule'] = '連結到這一模組';
$string['linktourl'] = '和此項目相關的連結';
