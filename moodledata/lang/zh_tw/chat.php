...
/**
 * Strings for component 'chat', language 'zh_tw', version '5.0'.
 *
 * @package     chat
 * @category    string
...
$string['beep'] = '呼叫';
$string['bubble'] = '鬆散';
$string['cantlogin'] = '無法登入聊天室';
$string['chat:addinstance'] = '新增聊天';
$string['chat:chat'] = '進出聊天室';
$string['chat:deletelog'] = '刪除聊天室日誌';
$string['chat:exportparticipatedsession'] = '匯出您有參與聊天的段落';
$string['chat:exportsession'] = '匯出任何聊天對話';
$string['chat:readlog'] = '檢視聊天記錄';
$string['chat:talk'] = '在聊天室發言';
$string['chat:view'] = '檢視聊天活動';
$string['chatintro'] = '描述';
...
$string['enterchat'] = '進入聊天室';
$string['entermessage'] = '輸入您的訊息';
$string['errornousers'] = '找不到任何用戶！';
$string['eventmessagesent'] = '訊息已送出';
$string['eventsessionsviewed'] = '檢視對話時段';
...
$string['indicator:cognitivedepth_help'] = '這指標代表學生在聊天活動中所達到的認知深度';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = '社會廣度指標';
$string['indicator:socialbreadth_help'] = '這指標代表學生在聊天活動中所達到的社會廣度';
...
$string['privacy:metadata:chat_users'] = '追踪哪些用戶在哪個聊天室';
$string['privacy:metadata:chat_users:firstping'] = '第一次訪問聊天室的時間';
$string['privacy:metadata:chat_users:ip'] = '用戶IP';
$string['privacy:metadata:chat_users:lang'] = '用戶語言';
$string['privacy:metadata:chat_users:lastmessageping'] = '此聊天室中最後一條消息的時間';
$string['privacy:metadata:chat_users:lastping'] = '最近一次訪問聊天室的時間';
$string['privacy:metadata:chat_users:userid'] = '用戶編號';
$string['privacy:metadata:messages:message'] = '訊息';
$string['privacy:metadata:messages:timestamp'] = '訊息發送的時間';
$string['privacy:metadata:messages:userid'] = '這訊息的作者的用戶編號';
...
$string['saidto'] = '對';
$string['savemessages'] = '保存過去的對話時段內容';
$string['search:activity'] = '聊天 - 活動訊息';
...
$string['sessionstartsin'] = '下一次聊天將在 {$a} 後開始。';
$string['strftimemessage'] = '%H:%M';
$string['studentseereports'] = '所有人都可查看過去的對話時段內容';
...
$string['usingchat_help'] = '<p>聊天室模組提供了如下模組以讓聊天更加有趣。</p>
<dl>
<dt><b>表情圖示</b></dt>
...
<dt><b>誇張情緒</b></dt>
<dd>在行首添加“/me”或者“:”可以將這行變成誇張情緒描述。例如，如果假設您叫Kim，並且您輸入了“:laughs!”或者“/me laughs!”，則所有人都會看到“Kim laughs!”</dd>
<dt><b>喚醒</b></dt>
<dd>您可以通過點擊別人姓名旁的“beep”鏈結來喚醒他。要想一下子喚醒所有的人，可以輸入“beep all”。</dd>
<dt><b>HTML</b></dt>
<dd>如果您知道如何是用HTML，您可以在您輸入的文字中加入HTML，這樣就可以插入圖片、播放聲音或者使用不同顏色和大小的文字。</dd>
</dl>
　　
　　';
$string['viewreport'] = '過往的聊天';
