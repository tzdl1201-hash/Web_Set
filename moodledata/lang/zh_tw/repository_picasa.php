...
/**
 * Strings for component 'repository_picasa', language 'zh_tw', version '5.0'.
 *
...
$string['configplugin'] = 'Picasa倉儲設定';
...
$string['picasa:view'] = '檢視Picasa倉儲';
$string['pluginname'] = 'Picasa網路相簿';
$string['secret'] = '密碼';
