...
/**
 * Strings for component 'plagiarism_turnitin', language 'zh_tw', version '5.0'.
 *
...
$string['defaults'] = '預設的設定值';
$string['defaultsdesc'] = '以下設定是預設設定當在活動模組中開啟了Turnitin';
$string['defaultupdated'] = '已更新Turnitin預設設定';
...
$string['turnitindefaults'] = 'Turnitin剽竊外掛預設設定';
