...
/**
 * Strings for component 'filter_mathjaxloader', language 'zh_tw', version '5.0'.
 *
...
$string['httpsurl'] = 'MathJax 網址';
$string['httpsurl_help'] = 'MathJax 程式庫的完整網址';
...
$string['privacy:metadata'] = '這一 Maxthjax 外掛程式沒有儲存任何個人資料';
