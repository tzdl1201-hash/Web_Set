...
/**
 * Strings for component 'hsuforum', language 'zh_tw', version '5.0'.
 *
 * @package     hsuforum
 * @category    string
...
$string['namenews'] = '公佈欄';
$string['namenews_help'] = '新聞討論區是在建立一課程時自動產生的，用於向學生公告訊息。一個課程只能有一個新聞討論區，只有教師和管理員可以在這裡貼文。這"最新消息"區塊將顯示新聞討埨區的新進議題。';
