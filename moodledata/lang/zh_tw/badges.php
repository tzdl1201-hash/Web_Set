...
/**
 * Strings for component 'badges', language 'zh_tw', version '5.0'.
 *
 * @package     badges
 * @category    string
...
$string['addedtobackpack'] = '已新增獎章到收藏服務';
$string['addtobackpack'] = '放入收藏服務';
$string['adminonly'] = '這一頁面只能給網站管理員使用';
$string['after'] = '在頒授的日期之後';
$string['aggregationmethod'] = '整合的方法';
$string['alignment'] = '對齊方式';
$string['all'] = '全部';
$string['allmethod'] = '符合全部選出的條件';
$string['allmethodactivity'] = '完成全部選出的活動';
$string['allmethodbadges'] = '所有被選出的贏得的獎章';
$string['allmethodcohort'] = '所有被選出的同期生的資格';
...
$string['allowexternalbackpack'] = '外部獎章收藏服務的連結';
...
$string['anymethodbadges'] = '任何被選出的贏得的獎章';
$string['anymethodcohort'] = '任何被選出的同期生的資格';
...
$string['attachment_help'] = '若勾選，一個頒發的獎章將會附加在收件者的電子郵件上以便下載。(你必須透過網站管理 >外掛 > 訊息輸出 > 電子郵件，來啟用附件)';
$string['award'] = '授與獎章';
$string['awardedto'] = '頒發給 {$a}';
$string['awardedtoyou'] = '頒發給我';
$string['awardoncron'] = '這一獎章的存取功能已經成功啟用。由於有太多用戶可以立即贏得這一獎章，為確保網站的效能，這一頒發動作將花一些時間來處理。';
$string['awards'] = '收件者';
$string['backpackapiurl'] = '獎章收藏服務API網址';
...
$string['backpackbadgessettings'] = '變更獎章收藏設定';
$string['backpackcannotsendverification'] = '無法送出驗證用電子郵件';
$string['backpackconnected'] = '獎章收藏服務已連接';
...
$string['backpackconnectioncancelattempt'] = '使用不同的電子郵件地址來連結';
$string['backpackconnectionconnect'] = '連結到獎章收藏夾';
$string['backpackconnectionresendemail'] = '重新送出驗證用電子郵件';
$string['backpackconnectionunexpectedresult'] = '無法連結到你的獎章收藏夾。請再嘗試一次。<br><br>若問題持續在，請聯絡您的網站管理員。';
$string['backpackdetails'] = '獎章收藏設定';
$string['backpackdisconnected'] = '獎章收藏服務已斷線';
$string['backpackemailverificationpending'] = '驗證擱置中';
$string['backpackemailverifyemailsubject'] = '{$a}:開放獎章收藏夾電子郵件驗證';
$string['backpackemailverifysuccess'] = '謝謝您驗證了您的電子郵件地址。您現在可以連結到您的獎章收藏夾。';
...
$string['backpackprovider'] = '獎章收藏服務提供著';
$string['backpacksettings'] = '獎章收藏設定';
$string['backpackweburl'] = '獎章收藏服務網址';
...
$string['bendorsement'] = '簽署';
$string['bmessage'] = '訊息';
$string['boverview'] = '綜覽';
$string['bydate'] = '完成於';
$string['claimcomment'] = '簽署意見';
$string['claimid'] = '聲明網址';
...
$string['criteria_descr_6'] = '下列<strong>{$a}</strong>個用戶資料欄位必須完成：';
...
$string['criteria_descr_single_6'] = '必須完成下列用戶個人資料欄位：';
...
$string['defaultissuercontact_desc'] = '';
...
$string['error:badgeawardnotfound'] = '無法確認這一頒發的獎章。這獎章可能已被撤銷。';
$string['error:badgenotfound'] = '沒有發現獎章';
$string['error:cannotact'] = '無法啟用這個獎章';
$string['error:cannotawardbadge'] = '無法授予獎章給用戶';
$string['error:cannotdeletecriterion'] = '這一規準不可以被刪除';
$string['error:cannotrevokebadge'] = '無法從用戶那邊撤銷獎章';
...
$string['error:nosuchfield'] = '警告：這一用戶資料欄位已經無法使用';
...
$string['eventbadgearchived'] = '獎章已存檔';
$string['eventbadgeawarded'] = '已頒授獎章';
$string['eventbadgecreated'] = '獎章已建立';
$string['eventbadgecriteriacreated'] = '獎章規準已建立';
$string['eventbadgecriteriadeleted'] = '獎章規準已刪除';
$string['eventbadgecriteriaupdated'] = '獎章規準已更新';
$string['eventbadgedeleted'] = '獎章已刪除';
$string['eventbadgedisabled'] = '獎章已關閉';
$string['eventbadgeduplicated'] = '獎章已複製';
$string['eventbadgeenabled'] = '獎章已啟用';
$string['eventbadgelistingviewed'] = '已檢視獎章清單';
$string['eventbadgerevoked'] = '獎章已撤銷';
$string['eventbadgeupdated'] = '獎章已更新';
$string['eventbadgeviewed'] = '已檢視獎章';
$string['existingrecipients'] = '現有獎章的收件人';
$string['expired'] = '已經失效';
$string['expiredate'] = '這獎章在{$a}失效';
$string['expireddate'] = '這獎章已經在{$a}過期失效';
$string['expiredin'] = '已過期 {$a}';
...
$string['imageauthoremail'] = '圖片作者的電子郵件';
$string['imageauthorname'] = '圖片作者的名字';
$string['imageauthorurl'] = '圖片作者的網址';
$string['imagecaption'] = '圖片標題';
$string['issuancedetails'] = '獎章到期';
$string['issuedbadge'] = '頒授獎章的訊息';
$string['issuedby'] = '頒發單位：{$a}';
$string['issuedon'] = '頒發日期：{$a}';
$string['issuerdetails'] = '頒授者細節';
$string['issueremail'] = '電子郵件';
$string['issuername'] = '名稱';
$string['issuername_help'] = '頒授機關或主管的名稱';
$string['issuerurl'] = '網址';
$string['language'] = '語言';
$string['listbackpacks'] = '獎章收藏服務清單';
...
$string['managebackpacks'] = '管理獎章收藏服務';
