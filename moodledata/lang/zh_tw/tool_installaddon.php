...
/**
 * Strings for component 'tool_installaddon', language 'zh_tw', version '5.0'.
 *
...
$string['acknowledgement'] = '確認';
$string['acknowledgementtext'] = '我知道在安裝額外的外掛之前，將這個網站做完整的備份是我的責任。我接受並理解到這些外掛(特別是，但非侷限於，源自非官方的程式碼)可能有安全上的漏洞，會導致網站掛掉，或造成私人資料的洩漏或遺失。';
