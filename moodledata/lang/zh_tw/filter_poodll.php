...
/**
 * Strings for component 'filter_poodll', language 'zh_tw', version '5.0'.
 *
...
$string['videotranscodedetails'] = '在存儲到Moodle之前，將錄製/上傳的影音檔轉換為MP4格式。這只適用於在tokyo.poodll.com上進行的錄製，或如果使用FFMPEG上傳的錄製檔。';
