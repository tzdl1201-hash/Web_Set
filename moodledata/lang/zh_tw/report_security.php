...
/**
 * Strings for component 'report_security', language 'zh_tw', version '5.0'.
 *
...
$string['check_crawlers_details'] = '這"對Google開放"設定可以讓搜尋引擎以訪客身分進入課程。若已經不允許訪客登入，那開啟這設定是無效的。';
$string['check_crawlers_error'] = '錯誤！你允許搜尋引擎存取，但關閉訪客存取已經關閉';
$string['check_crawlers_info'] = '搜尋引擎可以用訪客身分進入';
$string['check_crawlers_name'] = '對Google開放';
$string['check_crawlers_ok'] = '不允許搜尋引擎進入存取';
...
$string['check_embed_error'] = '已經啟用無限制的物件嵌入---這對於大多數的伺服器都是非常危險的';
$string['check_embed_name'] = '允許EMBED 和 OBJECT';
$string['check_embed_ok'] = '不允許無限制的物件嵌入';
...
$string['check_preventexecpath_name'] = '執行的路徑';
$string['check_preventexecpath_ok'] = '執行路徑只可以在 config.php 上設定';
$string['check_preventexecpath_warning'] = '可以在管理介面上設定執行路徑';
