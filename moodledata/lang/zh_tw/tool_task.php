...
/**
 * Strings for component 'tool_task', language 'zh_tw', version '5.0'.
 *
 * @package     tool_task
 * @category    string
...
$string['asap'] = '儘快';
$string['backtoscheduledtasks'] = '回到事先排定的工作';
$string['blocking'] = '封鎖';
...
$string['runnow'] = '現在執行';
$string['runnow_confirm'] = '你確定現在要執行這一工作 &lsquo;{$a}&rsquo;？這工作將會在網路伺服器上執行，且可能會花一些時間才能完成。';
