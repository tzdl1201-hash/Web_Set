...
/**
 * Strings for component 'error', language 'zh_tw', version '5.0'.
 *
 * @package     error
 * @category    string
...
$string['agedigitalconsentmapinvalidage'] = '"{$a}" 不是年齡的有效值';
$string['agedigitalconsentmapinvalidcountry'] = '"{$a}" 不是國家的有效值';
$string['agedigitalconsentmapinvaliddefault'] = '找不到預設(*)值';
$string['agelocationverificationdisabled'] = '年齡和地區的驗證已被關閉';
...
$string['blockcannotconfig'] = '此區塊不支持全站配置';
...
$string['cannotedityourprofile'] = '抱歉，你無法編輯自己的個人資料表';
...
$string['courseidnumbertaken'] = '編號已經被另一個課程({$a})使用了';
...
$string['csvloaderror'] = '當裝載CSV檔案 {$a}時，發生錯誤!';
...
$string['dmltransactionexception'] = '資料庫轉換發生錯誤';
...
$string['duplicateusername'] = '用戶名稱重複：跳過紀錄';
...
$string['groupalready'] = '用戶已隸屬於群組 {$a}';
...
$string['invalidcourselevel'] = '情境階級不正確';
...
$string['invalidsesskey'] = '您的連線很可能逾時了，請重新登入。';
...
$string['mnetlocal'] = '遠端MNET用戶不能在其當地登入';
...
$string['movecategorynotpossible'] = '你不可以將類別{$a}搬移到這被選出之目錄';
...
$string['nocontext'] = '很抱歉，但此課程不是一個有效的情境';
$string['nodata'] = '沒有資料';
...
$string['nopermissions'] = '抱歉，您目前沒有權限執行 ({$a})';
$string['nopermissiontoaccesspage'] = '您沒有權限存取此頁面。';
...
$string['nopermissiontoimportact'] = '你沒有權限去匯入活動到到這一課程。';
...
$string['nopermissiontoupdatecalendar'] = '抱歉，您沒有權限更新此行事曆事件。';
...
$string['restrictedcontextexception'] = '抱歉，執行外部函式違反了情境限制。';
...
$string['sessionerroruser'] = '您的連線逾時，請重新登入。';
$string['sessionerroruser2'] = '檢測到影響您登入連線的伺服器錯誤。請再登入或重新啟動您的瀏覽器。';
$string['sessionexpired'] = '連線逾時';
$string['sessionhandlerproblem'] = '會話處理程序之設定錯誤';
$string['sessionipnomatch'] = '抱歉，您的IP似乎與您初次登入時不符，這個安全性功能可以預防駭客以您的身份竊取您登入此站的資料，一般用戶可能不會看到這個訊息，請向系統管理者求助。';
...
$string['storedfilecannotcreatefiledirs'] = '無法建立本地端檔案儲存目錄。 請通知平台管理員檢查dataroot中的權限。';
$string['storedfilecannotread'] = '無法讀取檔案，可能是這檔案不存在或是有權限上的問題';
$string['storedfilecannotreadfile'] = '無法讀取檔案\'{$a}\'。如果不是檔案不存在，就是有權限問題';
...
$string['usernotdeleteddeleted'] = '這一用戶已經被刪除';
$string['usernotdeletederror'] = '用戶沒被刪除 --錯誤!';
$string['usernotdeletedmissing'] = '用戶沒被刪除---無法找到用戶名稱';
...
$string['usernotrenamedoff'] = '用戶沒被更名---不允許更名';
$string['usernotupdatedadmin'] = '不能更新管理者帳號';
$string['usernotupdatederror'] = '用戶沒被更新---錯誤';
$string['usernotupdatednotexists'] = '用戶沒被更新---不存在';
$string['userquotalimit'] = '您已經達到了您的檔案容量配額上限。';
$string['userselectortoomany'] = '儘管多重選擇設定為false，用戶選擇器仍然選出多於一個選出的用戶。';
$string['verifyagedigitalconsentnotpossible'] = '抱歉，現在無法進行數位年齡同意驗證';
$string['wrongcall'] = '該指令碼呼叫錯誤';
$string['wrongcontextid'] = '情境ID錯誤（無法找到該ID）';
