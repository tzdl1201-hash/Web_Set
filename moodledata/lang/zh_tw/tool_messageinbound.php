...
/**
 * Strings for component 'tool_messageinbound', language 'zh_tw', version '5.0'.
 *
...
$string['component'] = '元件';
$string['configmessageinboundhost'] = '要指定一個非預設的埠，你可以使用[server]:[port](例如mail.example.com:993) 的格式。
