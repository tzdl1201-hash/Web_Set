...
/**
 * Strings for component 'qformat_xml', language 'zh_tw', version '5.0'.
 *
 * @package     qformat_xml
 * @category    string
...
$string['truefalseimporterror'] = '<b>警告</b>：這是非題"{$a->questiontext}"無法正常地匯入，它無法查明正確答案為"是"或"非"。

此試題暫時以答案為"{$a->answer}"匯入，如果不正確，你需要事後再編輯這試題。';
$string['unsupportedexport'] = '以XML檔匯出時，不支援題型 {$a}';
