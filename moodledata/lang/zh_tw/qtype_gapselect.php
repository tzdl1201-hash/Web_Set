...
/**
 * Strings for component 'qtype_gapselect', language 'zh_tw', version '5.0'.
 *
...
$string['pluginname'] = '選擇式填空題';
$string['pluginname_help'] = '選擇式填空題是要求學生從下拉選單中找出正確的字來填入文章中的缺漏字詞。
...
$string['pluginnameadding'] = '新增一選擇式填空題';
$string['pluginnameediting'] = '編輯一選擇式填空題';
$string['pluginnamesummary'] = '使用下拉選單來填入試題文章中所缺漏的文字';
$string['shuffle'] = '選項隨機排列？';
$string['tagsnotallowed'] = '{$a->tag}是不允許的。(只有{$a->allowed}是被允許的)';
$string['tagsnotallowedatall'] = '{$a->tag}是不允許的。 (這兒不允許使用)';
