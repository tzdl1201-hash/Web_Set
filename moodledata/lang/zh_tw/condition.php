...
/**
 * Strings for component 'condition', language 'zh_tw', version '5.0'.
 *
 * @package     condition
 * @category    string
...
$string['adduserfields'] = '加入 {no} 個用戶欄位條件到表單中';
...
$string['completioncondition_help'] = '到那些活動的完成條件。注意，在設定完成條件之前，必須先設定好進度追蹤。

如果需要，也可以設定多條活動完成條件。那麼必須先滿足所有的活動條件，才能參加本活動。';
$string['completionconditionsection'] = '活動完成條件';
$string['completionconditionsection_help'] = '這一設定決定為了要存取這一學習單元，所必須符合的任何活動完成條件。

注意這完成與否的追蹤必須先設定，那活動完成條件才可以設定。

如果要的話，你也可以設定多重活動完成條件。如果這樣，只有在所有的活動完成條件都符合之後，才可以存取這學習單元。';
...
$string['endswith'] = '結尾是';
$string['fielddeclaredmultipletimes'] = '您不可以在每一活動宣告相同的欄位多於一次';
...
$string['gradeconditionsection'] = '成績條件';
$string['gradeconditionsection_help'] = '此設定決定在參加活動之前，必須先滿足那些成績條件。
...
$string['groupingnoaccess'] = '您目前不屬於有存取此學習單元權限的群組。';
$string['isempty'] = '空的';
$string['isequalto'] = '等於';
$string['isnotempty'] = '非空白';
$string['none'] = '（無）';
...
$string['requires_grouping'] = '專供<strong>{$a}</strong>群組存取。';
$string['requires_user_field_contains'] = '不可使用，除非您的<strong>{$a->field}</strong>包含<strong>{$a->value}</strong>。';
$string['requires_user_field_doesnotcontain'] = '不可使用，若您的<strong>{$a->field}</strong>包含<strong>{$a->value}</strong>。';
$string['requires_user_field_endswith'] = '不可使用，除非您的<strong>{$a->field}</strong>是以<strong>{$a->value}</strong>結束。';
$string['requires_user_field_isempty'] = '不可使用，除非您的<strong>{$a->field}</strong>是空的。';
$string['requires_user_field_isequalto'] = '不可使用，除非您的<strong>{$a->field}</strong>是等於<strong>{$a->value}</strong>。';
$string['requires_user_field_isnotempty'] = '不可使用。若您的<strong>{$a->field}</strong>是空的。';
$string['requires_user_field_startswith'] = '不可使用，除非您的<strong>{$a->field}</strong>是以<strong>{$a->value}</strong>開始的。';
$string['showavailability'] = '在活動可以存取之前';
$string['showavailability_hide'] = '在這課程和成績簿中完全隱藏活動';
$string['showavailability_show'] = '活動已用灰色顯示，並顯示受到限制的訊息';
$string['showavailabilitysection'] = '在學習單元之前可以存取';
$string['showavailabilitysection_hide'] = '完全隱藏學習單元';
$string['showavailabilitysection_show'] = '學習單元已用灰色顯示，並顯示受到限制的訊息';
$string['startswith'] = '開頭是';
$string['userfield'] = '用戶欄位';
$string['userfield_help'] = '您可以依據用戶資料表的任何欄位來限制存取。';
