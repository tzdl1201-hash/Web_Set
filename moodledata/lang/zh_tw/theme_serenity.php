...
/**
 * Strings for component 'theme_serenity', language 'zh_tw', version '5.0'.
 *
...
<h2>關於</h2>
<p>Serenity是一個可變寬度、三欄的Moodle 2.0布景主題。

<h2>調整</h2>
<p>本布景主題是基於Moodle核心的基本布景主題和布景主題構建。如果您想修改它，我們建議您在修改之前先複製一份並換名稱。這樣將來Moodle升級時才不會覆蓋您定制的布景主題。而且一旦您搞亂了它，還有原始檔的備份。關於修改布景主題的更多資訊，請瀏覽<a href="http://docs.moodle.org/en/Theme">Moodle文檔</a>。
</p>
<h2>致謝</h2>
<p>本布景主題由NewSchool Learning的Patrick Malley編寫和維護。可以通過contact@newschoollearning.com聯繫他。</p>
