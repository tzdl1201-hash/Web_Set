...
/**
 * Strings for component 'qtype_ordering', language 'zh_tw', version '5.0'.
 *
...
$string['gradingtype'] = '評分類型';
$string['gradingtype_help'] = '選擇評分計算的類型。
...
$string['moved'] = '{$a->item} 已移動。新位置：第 {$a->position} 項（共 {$a->total} 項）。';
