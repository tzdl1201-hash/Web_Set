...
/**
 * Strings for component 'tool_behat', language 'zh_tw', version '5.0'.
 *
 * @package     tool_behat
 * @category    string
...
$string['unknownexceptioninfo'] = '網頁測試工具Selenium 或您的瀏覽器有問題，請確定您是使用網頁測試工具Selenium 的最新版本。錯誤：';
