...
/**
 * Strings for component 'apply', language 'zh_tw', version '5.0'.
 *
 * @package     apply
 * @category    string
...
$string['add_item'] = '新增項目';
$string['add_items'] = '新增多個項目';
...
$string['no_table'] = '表格未有開始Tag';
$string['no_templates_available_yet'] = '尚無範本';
$string['no_title'] = '無標題';
$string['not_close_table'] = '表格未關閉';
...
$string['printpagebreak'] = '新增分頁符號';
$string['public'] = '公開。';
$string['radio'] = '收音機按鈕。';
$string['radiobutton'] = '單選按鈕';
$string['radiobutton_rated'] = '圓形按鈕（評分）';
...
$string['stop'] = '結束。';
$string['subject'] = '主題。';
$string['submit_form_button'] = '新申請表';
$string['submit_new_apply'] = '提交一張新的申請表';
