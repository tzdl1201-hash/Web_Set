...
/**
 * Strings for component 'workshop', language 'zh_tw', version '5.0'.
 *
 * @package     workshop
 * @category    string
...
$string['createsubmission'] = '新增作業提交';
...
$string['submissionrequiredcontent'] = '您必須輸入文字或上傳檔案。';
...
$string['yoursubmissionwithassessments'] = '您的作業提交與評分';
