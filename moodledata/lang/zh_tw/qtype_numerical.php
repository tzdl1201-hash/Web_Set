...
/**
 * Strings for component 'qtype_numerical', language 'zh_tw', version '5.0'.
 *
...
$string['addmoreanswerblanks'] = '多增加 {no} 個空白答案';
...
$string['errorrepeatedunit'] = '不能有兩個單位使用相同的名稱';
$string['geometric'] = '幾何的';
$string['invalidnumber'] = '你必須輸入一有效的數字';
$string['invalidnumbernounit'] = '您必須輸入一有效的數字，你的答案中不要包含單位';
...
$string['pluginname_help'] = '從學生的觀點，數字題看起來就像簡答題，其中的差異在於數字題允許有一可接受的誤差。
