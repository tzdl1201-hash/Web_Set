...
/**
 * Strings for component 'qbehaviour_adaptive', language 'zh_tw', version '5.0'.
 *
...
$string['gradingdetailswithadjustment'] = '這次提交的分數： {$a->raw}/{$a->max}。 若加上先前的作答記錄，可得到 <strong>{$a->cur}/{$a->max}</strong>。';
$string['gradingdetailswithadjustmentpenalty'] = '這次提交的分數： {$a->raw}/{$a->max}。 若加上先前的作答記錄，可得到 <strong>{$a->cur}/{$a->max}</strong>。這次的提交導致被扣 {$a->penalty}分。';
$string['gradingdetailswithadjustmenttotalpenalty'] = '這次提交的分數： {$a->raw}/{$a->max}。 若加上先前的作答記錄，可得到 <strong>{$a->cur}/{$a->max}</strong>。這次的提交導致被扣 {$a->penalty}分。到目前為止總共被扣{$a->totalpenalty}分。';
