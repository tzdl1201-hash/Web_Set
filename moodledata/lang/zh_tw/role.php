...
/**
 * Strings for component 'role', language 'zh_tw', version '5.0'.
 *
 * @package     role
 * @category    string
...
$string['assignroles_help'] = '透過在某個情境中指派角色給某一用戶，您可以給予用戶該角色擁有的權限，但只限於目前情境和所屬下層的情境中。
...
$string['checkuserspermissionshere'] = '檢查{$a->fullname}在此{$a->contextlevel}擁有的權限';
...
$string['confirmroleprevent'] = '您確定 {$a->context} 情境 具有{$a->cap} 權限的角色清單中，要移除<strong>{$a->role} </strong>嗎？';
$string['confirmroleunprohibit'] = '您確定 {$a->context} 情境 禁止有{$a->cap} 權限的角色清單中，要移除<strong>{$a->role} </strong>嗎？';
...
$string['course:configuredownloadcontent'] = '設定課程內容下載功能';
$string['course:create'] = '建立課程';
$string['course:delete'] = '刪除課程';
$string['course:downloadcoursecontent'] = '下載課程內容';
$string['course:enrolconfig'] = '設定課程中的選課實例';
$string['course:enrolreview'] = '審查選課';
$string['course:ignoreavailabilityrestrictions'] = '忽視可用性的限制';
...
$string['course:viewhiddensections'] = '檢視隱藏的學習單元';
...
$string['deleterolesure'] = '您確定要刪除角色“{$a->name} ({$a->shortname})”嗎？</p><p>目前此角色已經指派給{$a->count}個用戶了。';
...
$string['globalroleswarning'] = '警告！您在這一頁面指派的任何角色都將成為該用戶的全系統角色，在整個網站都有效，包括首頁和所有的課程。';
$string['gotoassignroles'] = '跳到為{$a->contextlevel}所指派的角色';
...
$string['grade:manageletters'] = '管理文字等第';
...
$string['grade:viewall'] = '檢視所有用戶的成績(含隱藏的)';
...
$string['inactiveformorethan'] = '以上 {$a->timeperiod}無效';
...
$string['maybeassignedin'] = '這角色可以被指派的情境的類型';
...
$string['nocapabilitiesincontext'] = '在此情境中沒有可使用的權限';
...
$string['noroles'] = '沒有角色';
$string['notabletoassignroleshere'] = '管理員沒有啟用在這情境下指派角色的功能';
...
$string['overridecontext'] = '修改情境';
$string['overridepermissions'] = '撤銷權限';
$string['overridepermissions_help'] = '透過修改權限可以在特定的情境中允許或禁止做某些動作。';
$string['overridepermissions_link'] = 'admin/roles/override';
$string['overridepermissionsforrole'] = '修改"{$a->role}"在{$a->context}中的權限';
$string['overridepermissionsin'] = '在{$a}中撤銷權限';
$string['overrideroles'] = '撤銷角色';
$string['overriderolesin'] = '在{$a}中撤銷角色';
$string['overrides'] = '撤銷';
$string['overridesbycontext'] = '修改(按情境)';
$string['permission'] = '權限';
$string['permission_help'] = '權限是關於能力的設定。它有四個選項：

* 沒有設定
* 允許 - 有使用此能力的權限
* 阻止 - 移除使用此能力的權限，即便在更高層情境中被允許
* 禁止 - 完全被拒絕使用此權限，並且在任何更低層(更特定的)情境中也不能修改這個設定';
...
$string['potentialusers'] = '{$a}位潛在的用戶';
...
$string['restore:viewautomatedfilearea'] = '檢視自動備份區域';
$string['risks'] = '風險';
...
$string['roleallowinfo'] = '選擇一個角色，把它加入到允許在“{$a->context}”情境使用“{$a->cap}”權限的角色清單中：';
...
$string['roleprohibitinfo'] = '選擇一個角色，把它加入到禁止在“{$a->context}”情境使用“{$a->cap}”權限的角色清單中：';
$string['rolerepreset'] = '使用角色設定';
$string['roleresetdefaults'] = '預設';
$string['roleresetrole'] = '使用角色或原型';
$string['rolerisks'] = '角色風險';
$string['roles'] = '角色';
$string['roles_help'] = '角色是為整個系統而定義的權限的集合，你可以將它指派給在一特定的情境中特定的用戶。';
...
$string['site:maintenanceaccess'] = '當在維護模式時，存取網站';
$string['site:manageallmessaging'] = '為任何用戶添加、移除、封鎖和解封鎖聯絡人';
...
$string['whydoesuserhavecap'] = '為什麼{$a->fullname}在情境{$a->context}中有{$a->capability}權限？';
$string['whydoesusernothavecap'] = '為什麼{$a->fullname}在情境{$a->context}中沒有{$a->capability}權限？';
