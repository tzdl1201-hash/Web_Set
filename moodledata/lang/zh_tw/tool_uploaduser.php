...
/**
 * Strings for component 'tool_uploaduser', language 'zh_tw', version '5.0'.
 *
...
$string['assignedsysrole'] = '指派的系統角色{$a}';
...
$string['errors'] = '錯誤';
$string['invalidupdatetype'] = '依據所選用的上傳檔案類型，你不能選擇這一選項';
$string['nochanges'] = '不變更';
$string['pluginname'] = '用戶上傳';
$string['renameerrors'] = '修改名稱時發生錯誤';
$string['requiredtemplate'] = '必需的，您可使用此樣版語法( (%l = 姓, %f = 名, %u = 用戶名稱)。細節及實例，請參見說明。';
$string['rowpreviewnum'] = '預覽資料筆數';
$string['unassignedsysrole'] = '指派的系統角色{$a}';
$string['uploadpicture_baduserfield'] = '指定的用戶屬性無效，請重試。';
...
$string['uploaduserspreview'] = '預覽上傳的用戶帳號';
$string['uploadusersresult'] = '批次建立用戶的結果';
...
$string['uubulk'] = '選擇已進行大批用戶的處理';
$string['uubulkall'] = '所有用戶';
$string['uubulknew'] = '新用戶';
$string['uubulkupdated'] = '已更新的用戶';
$string['uucsvline'] = 'CSV列';
$string['uulegacy1role'] = '(原初學生) typeN=1';
$string['uulegacy2role'] = '(原初教師) typeN=2';
$string['uulegacy3role'] = '(原初助理教師) typeN=3';
$string['uunoemailduplicates'] = '防止電子郵件信箱重覆';
$string['uuoptype'] = '上傳類型';
$string['uuoptype_addinc'] = '全部加入，如果需要，在用戶名稱後加入計數';
$string['uuoptype_addnew'] = '只加入新的，略過已存在的用戶';
$string['uuoptype_addupdate'] = '加入新的並且更新已存在的用戶';
...
$string['uuupdateall'] = '以檔案及預設值整個覆寫';
$string['uuupdatefromfile'] = '以檔案整個覆寫';
$string['uuupdatemissing'] = '以檔案及預設值填滿缺少的';
