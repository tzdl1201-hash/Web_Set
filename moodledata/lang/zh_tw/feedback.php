...
/**
 * Strings for component 'feedback', language 'zh_tw', version '5.0'.
 *
 * @package     feedback
 * @category    string
...
$string['anonymous_user'] = '匿名用戶';
$string['answerquestions'] = '回答這問題';
...
$string['feedback:mapcourse'] = '將課程對應到全站回饋';
...
$string['indicator:cognitivedepth'] = '回饋的認知深度';
$string['indicator:cognitivedepth_help'] = '一個指標代表學生在回饋活動中所達到的認知深度';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = '回饋的社會廣度';
$string['indicator:socialbreadth_help'] = '一個指標代表學生在回饋活動中所達到的社會廣度';
...
$string['multichoiceoption'] = '<span class="權重">({$a->weight}) </span>{$a->name}';
$string['multichoicerated'] = '選擇題(評值)';
$string['multichoicetype'] = '選擇題類型';
$string['multiplesubmit'] = '可以多次填答';
$string['multiplesubmit_help'] = '若啟用，在匿名調查時，用戶可以不限次數填寫回饋單。';
$string['name'] = '名稱';
...
$string['oldvalueswillbedeleted'] = '目前的問題和所有的回應都會被刪除';
$string['only_one_captcha_allowed'] = '在一個回饋中，只允許有一個captcha';
$string['openafterclose'] = '你把開放日期指定在關閉日期之後';
$string['overview'] = '概要';
$string['page'] = '頁';
...
$string['privacy:metadata:completed:anonymousresponse'] = '這一提交是否要匿名方式使用';
$string['privacy:metadata:completed:timemodified'] = '這一提交的最近一次修改的時間';
$string['privacy:metadata:completed:userid'] = '完成回饋活動的用戶的ID編號';
$string['privacy:metadata:completedtmp'] = '仍在進行提交的一筆紀錄';
$string['privacy:metadata:value'] = '問題答案的一筆紀錄';
$string['privacy:metadata:value:value'] = '被選的答案';
$string['privacy:metadata:valuetmp'] = '仍在進行提交的問題答案的一筆紀錄';
$string['public'] = '共用';
$string['question'] = '問題';
...
$string['search:activity'] = '回饋--活動訊息';
...
$string['this_feedback_is_already_submitted'] = '您已提交此回饋。';
