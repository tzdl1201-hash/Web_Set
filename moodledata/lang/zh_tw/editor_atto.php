...
/**
 * Strings for component 'editor_atto', language 'zh_tw', version '5.0'.
 *
 * @package     editor_atto
 * @category    string
...
$string['errorgroupisusedtwice'] = '{$a}群組被定義了二次。群組名稱必須是獨一無二的才對。';
$string['errornopluginsorgroupsfound'] = '沒有外掛及群組。請新增一些外掛和群組。';
$string['errorpluginisusedtwice'] = '外掛{$a}被用了二次。外掛只能夠定義一次。';
$string['errorpluginnotfound'] = '外掛{$a}無法使用。它似乎尚未安裝。';
