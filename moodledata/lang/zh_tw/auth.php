...
/**
 * Strings for component 'auth', language 'zh_tw', version '5.0'.
 *
 * @package     auth
 * @category    string
...
$string['auth_loginpasswordtoggle'] = '密碼顯隱切換';
$string['auth_loginpasswordtoggle_desc'] = '在登入畫面上的密碼欄位新增一個圖示，讓使用者顯示或隱藏他們輸入的密碼。';
