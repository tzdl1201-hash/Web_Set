...
/**
 * Strings for component 'assignment', language 'zh_tw', version '5.0'.
 *
 * @package     assignment
 * @category    string
...
$string['assignmentdisabled'] = '這繼承的"作業2.2"活動已經關閉';
$string['assignmentneedsupgrade'] = '傳統的"作業2.2"已經被關閉。請要求你的網站管理員為這一網站的傳統作業執行作業升級工具。';
$string['messageprovider:assignment_updates'] = '作業(2.2)通知';
$string['modulename'] = '作業 (2.2)(關閉)';
$string['modulename_help'] = '先前的活動模組已經從Moodle中移除。';
$string['modulenameplural'] = '作業(2.2)(關閉)';
...
$string['pluginadministration'] = '作業2.2(已關閉)管理';
$string['pluginname'] = '作業2.2(已關閉)';
