...
/**
 * Strings for component 'grades', language 'zh_tw', version '5.0'.
 *
 * @package     grades
 * @category    string
...
$string['addidnumbers'] = '加入識別碼';
$string['additem'] = '增加評分項目';
$string['additionalfeedback'] = '額外回饋';
...
$string['availableidnumbers'] = '可使用的識別碼';
$string['average'] = '平均';
...
$string['calculation_help'] = '成績計算方法是一個用來決定成績的公式。該公式應該以等號（=）開始，且可以使用常見的數學運算，比如max、min和sum。如果需要，你也可以包含其它評分項目，你只需在公式中輸入評分項目的識別碼，並用兩個方括號括起來。';
...
$string['compact'] = '精簡';
$string['componentcontrolsvisibility'] = '這計分項目是否要隱藏，是由這活動的設定所控制。';
...
$string['editfeedback'] = '編輯回饋';
$string['editgrade'] = '編輯成績';
...
$string['gradebookcalculationswarning'] = '注意：已經偵測到在這成績簿上，在計算要顯示的分數時會有一些錯誤。如果你的課程還沒開始或正在進行中，它建議這錯誤可以藉由點選以下的按鈕來修正這一錯誤，這會導致一些分數被更改。若你的課程已經結束且分數已經提交出去，你最好不要去動這個問題。

成績簿較新的版本是 {$a->currentversion}，而你使用的是{$a->gradebookversion}。你可以在 <a href="{$a->url}">成績簿計算公式的更改</a>看到兩者間更動的清單。';
$string['gradebookhiddenerror'] = '成績簿目前設定為對學生隱藏所有項目';
$string['gradebookhistories'] = '成績的歷史紀錄';
$string['gradebooksetup'] = '成績簿設定';
...
$string['gradeexportuserprofilefields'] = '成績匯出用戶個人資料欄位';
...
$string['gradesmoduledeletionpendingwarning'] = '警告：正在進行刪除活動！某些分數即將被移除。';
$string['gradesmoduledeletionprefix'] = '[刪除進行中]';
...
* 其中一個欄位名稱必須要包含用戶的身分資料，不管是用戶名稱、學號或EMAIL位址。
...
$string['linktoactivity'] = '連結到 {$a->name} 活動 {$a->title}';
$string['lock'] = '鎖定';
$string['locked'] = '已鎖定';
...
$string['scaledpct'] = '量尺%';
$string['seeallcoursegrades'] = '檢視所有課程成績';
$string['select'] = '選擇 {$a}';
...
$string['showfeedback_help'] = '是否要顯示回饋列嗎？';
$string['showgrade'] = '顯示成績';
$string['showgrade_help'] = '是否要顯示成績列？';
...
$string['showlettergrade_help'] = '是否要顯示文字等第欄？';
...
$string['showpercentage_help'] = '是否要顯示每個成績項目的百分比？';
...
$string['showrank_help'] = '是否要顯示用戶的每項成績在班級中的排名？';
...
$string['showweight_help'] = '是否要顯示分數加權量欄位嗎？';
...
$string['userfields_show_help'] = '在成績報告上顯示附加的用戶欄位，比如說電子郵件信箱。這指定要顯示欄位是由網站"顯示用戶身分"的設定所控制。';
$string['usergrade'] = '用戶{$a->fullname}（{$a->useridnumber}）的成績項{$a->gradeidnumber}';
$string['userid'] = '用戶編號';
$string['useridnumberwarning'] = '沒有學號的用戶會在匯出時被排除，同時他們也無法被匯入。';
$string['usermappingerror'] = '用戶對應錯誤：無法找到{$a->value}的{$a->field}。';
...
$string['writinggradebookinfo'] = '寫入成績簿的設定';
$string['xml'] = 'XML';
$string['yes'] = '是';
